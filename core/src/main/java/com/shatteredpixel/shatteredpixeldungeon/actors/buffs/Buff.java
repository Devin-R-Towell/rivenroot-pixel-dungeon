...
public class Buff extends Actor {
	...
	// A list to hold negative buffs
	private static ArrayList<Buff> negativeBuffs = new ArrayList<>();
	...
	public boolean attachTo(Char target) {
		...
		if (target.add(this)) {
			...
			// Add to the negative buffs list if the buff is negative
			if (this.type == buffType.NEGATIVE) {
				negativeBuffs.add(this);
			}
