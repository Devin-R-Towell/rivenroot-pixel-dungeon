...
public class Twinkle extends Component {

    private enum Phase {
        FADE_IN, TWINKLING, FADE_OUT
    }

    private static final float FADE_IN_TIME		= 0.2f;
    private static final float TWINKLING_TIME	= 1.4f;
    ...
    public Twinkle(Item oldItem, Item newItem ){
    ...
    public Twinkle(Talent oldTalent, Talent newTalent ){
    ...
    public void update() {
        ...
        switch (phase) {
            case FADE_IN:
                ...
                break;
            case TWINKLING:
                oldSprite.alpha((TWINKLING_TIME - passed)  / duration * ALPHA);
    ...
    public static void show( Char ch, Item oldItem, Item newItem ) {
        ...
        Twinkle sprite = new Twinkle( oldItem, newItem );
        sprite.target = ch;
    ...
    public static void show( Char ch, Talent oldTalent, Talent newTalent ) {
        ...
        Twinkle sprite = new Twinkle( oldTalent, newTalent );
        sprite.target = ch;
        ch.sprite.parent.add( sprite );
    }
