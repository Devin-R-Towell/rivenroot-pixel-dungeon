...
public class Earthroot extends Plant {
	...
	public static class Fruit extends Plant.Fruit {
		{
			image = ItemSpriteSheet.FRUIT_EARTHROOT;

			seedClass = Earthroot.Seed.class;

			bones = true;

		}
		public String desc() {
			return "Eating this berry will thicken your skin to become as hard a bark. Temporarily shielding you.";
		}
	}
