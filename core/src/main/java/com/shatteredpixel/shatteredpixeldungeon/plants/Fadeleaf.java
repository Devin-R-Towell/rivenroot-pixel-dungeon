...
public class Fadeleaf extends Plant {
	...
	public static class Fruit extends Plant.Fruit {
		{
			image = ItemSpriteSheet.FRUIT_FADELEAF;

			seedClass = Fadeleaf.Seed.class;

			triggerBuff = "Fadeleaf";
		}
	}

	public String desc() {
		return "This powerful berry teleports it consumer to the previous floor.";
	}
}
